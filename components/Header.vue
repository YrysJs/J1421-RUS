<template>
    <header class="header">
      <div class="container">
        ...
        <nav class="nav">
          <ul>
            <li class="nav-notification" v-if="auth">
              <router-link to="/">
            ...
            <li v-if="auth">
              ...
              <div class="submenu" v-if="subMenu">
                ...
                <router-link to="/" @click="openCollapse">Мои отзывы</router-link>
                <router-link to="/support" @click="openCollapse">Служба поддержки</router-link>
                <button @click="openCollapse">Выйти из профиля</button>
              </div>
            </li>
            <li v-if="!auth" class="nav-auth">
